...
Our largest DevOps challenge throughout the project, was the necessary migration of our database from SQLite to PostGRE. %The problem originated early after the simulator was started. %A crash was noticed (see issue \href{https://github.com/DevelOpsITU/MiniTwit/issues/83}{\#83}), seemingly caused by a large tweet, 8000+ characters. Its discovery was through gin's automatic logging, visible in the docker logs found via ssh, since no logging nor monitoring existed at the time. The crash was repetitive. 
