...
The code follows the onion architecture pattern seen in  \autoref{fig:onion_architecture}. This pattern have been chosen to easily separate segments of the code.
